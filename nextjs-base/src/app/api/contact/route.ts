...
const emailTemplates = {
  fr: {
    ...
    greeting: 'Bonjour',
    body: 'J’ai bien reçu votre message et vous en remercie.',
    closing: 'Je vous répondrai dans les plus brefs délais.',
    signature: 'Amanda Fontannaz',
  ...
  en: {
    ...
    closing: 'I will respond to you as soon as possible.',
    signature: 'Amanda Fontannaz',
    footer: 'This email is sent automatically, please do not reply.',
  },
  it: {
    subject: 'Conferma di ricezione del suo messaggio',
    title: 'Grazie per il suo messaggio!',
    greeting: 'Buongiorno',
    body: 'Ho ricevuto il suo messaggio e la ringrazio.',
    closing: 'Le risponderò il prima possibile.',
    signature: 'Amanda Fontannaz',
    footer:
