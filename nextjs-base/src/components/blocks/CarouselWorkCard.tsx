...
const CarouselWorkCard = ({
  ...
  return (
    <div className="relative w-full h-45 mb-4 overflow-hidden rounded-lg shadow-lg hover:shadow-2xl transition-all duration-300 bg-[#FFE5B3]/60 flex-shrink-0 select-none">
      {/* Image */}
