  ...
  return (
    <>
      ...
      >
        ...
        <span className="pointer-events-none absolute bottom-2 right-2 w-7 h-7 bg-[#DDE8C4] text-white text-2xl font-bold rounded-full flex items-center justify-center leading-none">
          +
        </span>
      </div>
      {renderModal()}
